...
static const struct icp mkobjprobs[] = { { 0, WEAPON_CLASS },
                                         { 0, ARMOR_CLASS },
                                         { 100, FOOD_CLASS },
                                         { 0, TOOL_CLASS },
                                         { 0, GEM_CLASS },
...
static const struct icp boxiprobs[] = { { 0, GEM_CLASS },
                                        { 100, FOOD_CLASS },
                                        { 0, POTION_CLASS },
                                        { 0, SCROLL_CLASS },
                                        { 0, SPBOOK_CLASS },
...
static const struct icp rogueprobs[] = { { 0, WEAPON_CLASS },
                                         { 0, ARMOR_CLASS },
                                         { 100, FOOD_CLASS },
                                         { 0, POTION_CLASS },
                                         { 0, SCROLL_CLASS },
...
static const struct icp hellprobs[] = { { 0, WEAPON_CLASS },
                                        { 0, ARMOR_CLASS },
                                        { 100, FOOD_CLASS },
                                        { 0, TOOL_CLASS },
                                        { 0, GEM_CLASS },
