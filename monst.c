...
#define MON(nam, sym, lvl, gen, atk, siz, mr1, mr2, flg1, flg2, flg3, col) \
    {                                                                      \
        nam, sym, lvl+6, gen, atk, siz, mr1, mr2, flg1, flg2, flg3, C(col)   \
    }
#define ROCMON(nam, sym, lvl, gen, atk, siz, mr1, mr2, flg1, flg2, flg3, col) \
    {                                                                      \
        nam, sym, lvl, gen, atk, siz, mr1, mr2, flg1, flg2, flg3, C(col)   \
    }
/* LVL() and SIZ() collect several fields to cut down on # of args for MON()
 */
#define LVL(lvl, mov, ac, mr, aln) lvl+6, mov, ac, mr, aln
#define ROCLVL(lvl, mov, ac, mr, aln) lvl, mov, ac, mr, aln
...
NEARDATA struct permonst mons[] = {
     ...
     * ants
     */
    MON("giant ant", S_ANT, LVL(9, 18, 3, 0, 0), (G_GENO | G_SGROUP | 3),
        ...
        CLR_BROWN),
    MON("killer bee", S_ANT, LVL(9, 18, -1, 0, 0), (G_GENO | G_LGROUP | 2),
        ...
        CLR_YELLOW),
    MON("soldier ant", S_ANT, LVL(9, 18, 3, 0, 0), (G_GENO | G_SGROUP | 2),
     ...
     * blobs
     */
    MON("acid blob", S_BLOB, LVL(9, 3, 8, 0, 0), (G_GENO | 2),
     ...
     * dogs & other canines
     */
    MON("jackal", S_DOG, LVL(9, 12, 7, 0, 0), (G_GENO | G_SGROUP | 3),
        ...
        CLR_BROWN),
    MON("fox", S_DOG, LVL(9, 15, 7, 0, 0), (G_GENO | 1),
        A(ATTK(AT_BITE, AD_PHYS, 1, 3), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
        SIZ(300, 250, MS_BARK, MZ_SMALL), 0, 0,
        M1_ANIMAL | M1_NOHANDS | M1_CARNIVORE, M2_HOSTILE, M3_INFRAVISIBLE,
        CLR_RED),
    MON("coyote", S_DOG, LVL(9, 12, 7, 0, 0), (G_GENO | G_SGROUP | 1),
        A(ATTK(AT_BITE, AD_PHYS, 1, 4), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
        SIZ(300, 250, MS_BARK, MZ_SMALL), 0, 0,
        M1_ANIMAL | M1_NOHANDS | M1_CARNIVORE, M2_HOSTILE, M3_INFRAVISIBLE,
     ...
     * eyes
     */
    MON("gas spore", S_EYE, LVL(9, 0, 0, 10, 0), (G_NOCORPSE | G_GENO | 1),
        A(ATTK(AT_BOOM, AD_PHYS, 1, 8), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
        SIZ(10, 10, MS_SILENT, MZ_SMALL), 0, 0,
        M1_FLY | M1_BREATHLESS | M1_NOLIMBS | M1_NOHEAD | M1_MINDLESS,
        M2_HOSTILE | M2_NEUTER, 0, CLR_GRAY),
    ROCMON("floating eye", S_EYE, ROCLVL(0, 0, 3, 0, 0), (G_GENO | 5),
        A(ATTK(AT_NONE, AD_PLYS, 1, 6), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
        SIZ(900, 500, MS_SILENT, MZ_LARGE), 0, 0,
    ...
    MON("freezing sphere", S_EYE, LVL(6, 13, 4, 0, 0),
        ...
        A(ATTK(AT_EXPL, AD_COLD, 4, 6), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
        SIZ(300, 300, MS_SILENT, MZ_SMALL), MR_COLD, MR_COLD,
        M1_FLY | M1_BREATHLESS | M1_NOLIMBS | M1_NOHEAD | M1_MINDLESS
            | M1_NOTAKE,
     ...
     * humanoids
     */
    MON("hobbit", S_HUMANOID, LVL(9, 9, 10, 0, 6), (G_GENO | 2),
     ...
     * kobolds
     */
    MON("kobold", S_KOBOLD, LVL(9, 6, 10, 0, -2), (G_GENO | 1),
        ...
        M3_INFRAVISIBLE | M3_INFRAVISION, CLR_BROWN),
    MON("large kobold", S_KOBOLD, LVL(9, 6, 10, 0, -3), (G_GENO | 1),
        A(ATTK(AT_WEAP, AD_PHYS, 1, 6), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
     ...
     */
    MON("orc", S_ORC, LVL(9, 9, 10, 0, -3), (G_GENO | G_NOGEN | G_LGROUP),
        A(ATTK(AT_WEAP, AD_PHYS, 1, 8), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
     ...
     * rodents
     */
    MON("sewer rat", S_RODENT, LVL(9, 12, 7, 0, 0), (G_GENO | G_SGROUP | 1),
        A(ATTK(AT_BITE, AD_PHYS, 1, 3), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
        SIZ(20, 12, MS_SQEEK, MZ_TINY), 0, 0,
        M1_ANIMAL | M1_NOHANDS | M1_CARNIVORE, M2_HOSTILE, M3_INFRAVISIBLE,
        CLR_BROWN),
    MON("giant rat", S_RODENT, LVL(9, 10, 7, 0, 0), (G_GENO | G_SGROUP | 2),
        A(ATTK(AT_BITE, AD_PHYS, 1, 3), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
     ...
     */
    MON("cave spider", S_SPIDER, LVL(9, 12, 3, 0, 0), (G_GENO | G_SGROUP | 2),
        A(ATTK(AT_BITE, AD_PHYS, 1, 2), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
     ...
     * xan, &c
     */
    ROCMON("grid bug", S_XAN, ROCLVL(0, 12, 9, 0, 0),
     ...
     * Bats
     */
    MON("bat", S_BAT, LVL(9, 22, 8, 0, 0), (G_GENO | G_SGROUP | 1),
        A(ATTK(AT_BITE, AD_PHYS, 1, 4), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
     ...
     * Fungi
     */
    MON("lichen", S_FUNGUS, LVL(9, 1, 9, 0, 0), (G_GENO | 4),
    ...
    MON("brown mold", S_FUNGUS, LVL(9, 0, 9, 0, 0), (G_GENO | 1),
        A(ATTK(AT_NONE, AD_COLD, 0, 6), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
        ...
        M2_HOSTILE | M2_NEUTER, 0, CLR_BROWN),
    MON("yellow mold", S_FUNGUS, LVL(9, 0, 9, 0, 0), (G_GENO | 2),
    ...
    MON("green mold", S_FUNGUS, LVL(9, 0, 9, 0, 0), (G_GENO | 1),
        ...
        M1_BREATHLESS | M1_NOEYES | M1_NOLIMBS | M1_NOHEAD | M1_MINDLESS
            | M1_ACID | M1_NOTAKE,
        M2_HOSTILE | M2_NEUTER, 0, CLR_GREEN),
    MON("red mold", S_FUNGUS, LVL(9, 0, 9, 0, 0), (G_GENO | 1),
     ...
     * Gnomes
     */
    MON("gnome", S_GNOME, LVL(9, 6, 10, 4, 0), (G_GENO | G_SGROUP | 1),
        A(ATTK(AT_WEAP, AD_PHYS, 1, 6), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
...
struct permonst _mons2[] = {
     ...
     * Kops
     */
    MON("Keystone Kop", S_KOP, LVL(9, 6, 10, 10, 9),
     ...
     * Snakes
     */
    MON("garter snake", S_SNAKE, LVL(9, 8, 8, 0, 0), (G_LGROUP | G_GENO | 1),
        A(ATTK(AT_BITE, AD_PHYS, 1, 2), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
     ...
     * Zombies
     */
    MON("kobold zombie", S_ZOMBIE, LVL(9, 6, 10, 0, -2),
        (G_GENO | G_NOCORPSE | 1), A(ATTK(AT_CLAW, AD_PHYS, 1, 4), NO_ATTK,
                                     NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(400, 50, MS_SILENT, MZ_SMALL), MR_COLD | MR_SLEEP | MR_POISON, 0,
        M1_BREATHLESS | M1_MINDLESS | M1_HUMANOID | M1_POIS,
        M2_UNDEAD | M2_STALK | M2_HOSTILE, M3_INFRAVISION, CLR_BROWN),
    MON("gnome zombie", S_ZOMBIE, LVL(9, 6, 10, 0, -2),
...
#define SEDUCTION_ATTACKS_NO                                      \
    ...
    MON("Yeenoghu", S_DEMON, LVL(9, 0, -5, 80, -15),
        (G_HELL | G_NOCORPSE | G_NOGEN | G_UNIQ),
 ...
 */
     ...
     * lizards, &c
     */
    MON("newt", S_LIZARD, LVL(9, 6, 8, 0, 0), (G_GENO | 5),
        A(ATTK(AT_BITE, AD_PHYS, 1, 2), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
        SIZ(10, 20, MS_SILENT, MZ_TINY), 0, 0,
        M1_SWIM | M1_AMPHIBIOUS | M1_ANIMAL | M1_NOHANDS | M1_CARNIVORE,
        M2_HOSTILE, 0, CLR_YELLOW),
    MON("gecko", S_LIZARD, LVL(9, 6, 8, 0, 0), (G_GENO | 5),
        A(ATTK(AT_BITE, AD_PHYS, 1, 3), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
     ...
     */
    MON("long worm tail", S_WORM_TAIL, LVL(9, 0, 0, 0, 0),
        (G_NOGEN | G_NOCORPSE | G_UNIQ),
        A(NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
